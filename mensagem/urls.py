...
urlpatterns = [
    path('usuario/<str:id_usuario>/mensagem/enviar', EnviarMensagem.as_view(), name="enviar-mensagem"),
    path('usuario/<str:id_usuario>/mensagem/listar', ListarMensagens.as_view(), name='listar-mensagens'),
